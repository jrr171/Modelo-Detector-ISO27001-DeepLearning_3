...
ISO27001_DOMAINS: Dict[str, ControlDomain] = {
    ...
    "operations_security": ControlDomain(
        ...
        risk_patterns=[
            r"(?i)(error|critical|alert|emergency|kernel.*panic|"
            r"out.of.memory|oom.killer|disk.full|segfault|core.dump|"
            r"malware|virus|trojan|ransomware|failed to start)",
        ],
